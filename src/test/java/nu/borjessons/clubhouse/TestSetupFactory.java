...
class TestSetupFactory {
	...
	public static String registerNormalUserWithChildren(String clubId, String username, int numberOfChildren) {
	...
	public static String loginUser(String username) {
		Response loginResponse = given().log().all().contentType(TestConfiguration.APPLICATION_JSON)
				.accept(TestConfiguration.APPLICATION_JSON)
