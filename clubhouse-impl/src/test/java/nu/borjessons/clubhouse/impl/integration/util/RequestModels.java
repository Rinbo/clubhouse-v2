package nu.borjessons.clubhouse.impl.integration.util;
...
public class RequestModels {
  ...
  public static Map<String, Object> clubRegistrationRequest(
      String ClubName, String owner, String name) {
  ...
  public static Map<String, Object> userWithChildrenRegistrationRequest(
      String clubId, String user, String name, List<String> childrenNames) {
    Map<String, Object> userRequestModel = userRegistrationRequest(clubId, user, name);

    List<Map<String, Object>> children =
        childrenNames.stream()
            .map(child -> childRegistrationRequest(child))
  ...
  private static Map<String, Object> userRegistrationRequest(
      String clubId, String user, String name) {
